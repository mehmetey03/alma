...
BASE_URL = "https://dizifun5.com/unutulmaz"
...
def create_proxy_url(original_url):
    ...
    # Yeni proxy adresine göre yapılandır
...
async def process_series(all_series_links, output_filename="Unutulmaz Diziler.m3u"):
